...
void Mactangle::allTextsConfigure(MainClass& main)
{
	...
	charset.setFont(main.game_font);
	...
	number1.setFont(main.game_font);
	...
	number2.setFont(main.game_font);
...
{
	main.window.draw(charset);
	main.window.draw(number1);
	main.window.draw(number2);
}