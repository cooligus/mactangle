...
void Addidtionals::heartsConfigure(MainClass& main, int count)
{
	...
	for (int i = 1; i <= count; i++)
	{
		...
		hearts.back().setPosition((150 * (i-1)) + 40, main.camera.getSize().y - 30);
